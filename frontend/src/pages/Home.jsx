      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {!hasFilter && filteredVehicles.length > 6 && (
          <div className="text-center mt-10">
            <Link
              to="/vehiculos"
              className="inline-block bg-black hover:bg-gray-900 border-2 border-yellow-600 text-white font-semibold px-8 py-3 rounded-lg transition-colors duration-300"
            >
              Ver todos los vehículos
            </Link>
          </div>
