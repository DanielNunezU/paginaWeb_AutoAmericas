    ...
    <div className="bg-black min-h-screen py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-yellow-500 mb-4">Contáctenos</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-gray-800 border border-yellow-600/30 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-bold text-yellow-500 mb-6">Información de Contacto</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-100 mb-2">Teléfonos</h3>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <a href="tel:+573209669384" className="text-yellow-500 hover:underline">320 966 9384</a>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-gray-400 text-sm w-20">Asesor 3:</span>
                      <a href="tel:+573106440913" className="text-yellow-500 hover:underline">310 644 0913</a>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-gray-400 text-sm w-20">Asesor 4:</span>
                      <a href="tel:+573144018594" className="text-yellow-500 hover:underline">314 401 8594</a>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-gray-400 text-sm w-20">Asesor 5:</span>
                      <a href="tel:+573133473617" className="text-yellow-500 hover:underline">313 347 3617</a>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-gray-400 text-sm w-20">Asesor 6:</span>
                      <a href="tel:+573203866321" className="text-yellow-500 hover:underline">320 386 6321</a>
                    </div>
                    <div className="flex items-center gap-2">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-100 mb-2">WhatsApp</h3>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <span className="text-gray-400 text-sm w-20">Asesor 1:</span>
                      <a
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@autosduitama.com" className="text-purple-400 hover:underline">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-100 mb-1">Dirección</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-100 mb-1">Horario de Atención</h3>
                  <p className="text-gray-400">
          ...
          <div className="bg-gray-800 border border-yellow-600/30 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-bold text-yellow-500 mb-6">Envíanos un Mensaje</h2>
        ...
        <div className="mt-12 max-w-6xl mx-auto">
          <div className="bg-gray-800 border border-yellow-600/30 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-bold text-yellow-500 mb-6">Nuestra Ubicación</h2>
